...
tiff("plots/FIG4_FINAL_1.tiff", width = 260,height=160,units="mm",res=300, compression="lzw")
...
par(xpd=NA)
legend(86, 98, dd3_fig$Location, pch = dd3_fig$pch_urdt, col=dd3_fig$col, pt.cex = 1.4, title = "Study", bty="n")


legend(89, 11, c("HS-RDT estimated sensitivity", "Co-RDT estimated sensitivity"), col = "grey30", lwd=2,
       lty = c(1, 2))
