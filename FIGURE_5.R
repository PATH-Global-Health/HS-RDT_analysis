...
tiff("plots/FIG5_FINAL_1.tiff", width = 200,height=130,units="mm",res=300, compression="lzw")
...
points(dd3$uRDT.prevalence/dd3$RDT.prevalence, nrow(dd3):1,pch=21,
       bg = dd3$col, cex=1.4)
axis(2, nrow(dd3):1, dd3$Location, las=1, cex.axis = 0.8)
