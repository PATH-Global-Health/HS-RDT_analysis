...
tiff("plots/FINAL_submitted/SUPP_FIGURE_S2.tiff", width = 170,height=100,units="mm",res=300, compression="lzw")

par(mar = c(4,4,2,14), xpd=FALSE)

plot(dd$pcr_prevalence, dd$PPV, ylim = c(0, 1), xlab = "PCR Prevalence (%)", ylab = "Positive predictive value", las=1,
     pch = 21, bg = adjustcolor(dd$col, 0.8), cex = 1.4, cex.lab = 0.8, cex.axis = 0.8)
...
par(xpd=NA)
legend(59, 1.05, dd$location, pch = 21, pt.bg  =adjustcolor(dd$col, 0.8), pt.cex = 1.2, title = "Study", bty="n", cex =0.7)

legend(59, 0, c("HS-RDT", "co-RDT"), pch = c(21, 24), pt.bg  = "white", pt.cex = 1.2, title = "RDT", bty="n", cex =0.7)

dev.off()


tiff("plots/FINAL_submitted/SUPP_FIGURE_S3.tiff", width = 170,height=100,units="mm",res=300, compression="lzw")
